...
<%-- $Id: new.jsp 4 2004-04-20 19:58:10Z anderson $ --%>


<%@ include file="../header.jsp" %>

<form id="loginform" action="new.iwt" method="post">
  ...
  <table class="form">
    ...
    <jiwt:text msg="password.again" field="userInfo.passwordCheck" req="${true}" type="password"/>
  </table>

  <div class="submit">
    <input type="submit" name="SUBMIT" value="<fmt:message key="create"/>"/>
    <div class="note">
