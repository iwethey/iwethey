...
<%-- $Id: reply.jsp 26 2004-06-25 03:12:19Z anderson $ --%>


<%@ include file="../header.jsp" %>

  <form id="newpostform" action="reply.iwt" method="post">
    ...
    <input value="<c:out value="${replyTo.id}"/>" name="postid" type="hidden"/>  
  ...
  <div id="posts" class="${post.createdBy.nickname}">
    <table>
      <iwt:thread var="replyTo" content="true">
